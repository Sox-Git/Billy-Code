...
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_191_new,"flixel.effects.FlxFlicker","new",0x4bc826b6,"flixel.effects.FlxFlicker.new","flixel/effects/FlxFlicker.hx",191,0x4fa53f38)
...
void FlxFlicker_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_191_new)
            	}
...
HXLINE( 174)			this->progressCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 176)		bool _hx_tmp;
HXDLIN( 176)		if ((timer->loops > 0)) {
HXLINE( 176)			_hx_tmp = ((timer->loops - timer->_loopsCounter) == 0);
            		}
            		else {
HXLINE( 176)			_hx_tmp = false;
            		}
HXDLIN( 176)		if (_hx_tmp) {
HXLINE( 178)			this->object->set_visible(this->endVisibility);
HXLINE( 179)			if (::hx::IsNotNull( this->completionCallback )) {
HXLINE( 180)				this->completionCallback(::hx::ObjectPtr<OBJ_>(this));
            			}
HXLINE( 182)			if (::hx::IsInstanceEq( this->timer,timer )) {
HXLINE( 183)				this->release();
            			}
            		}
            	}
