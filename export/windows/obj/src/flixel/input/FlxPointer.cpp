...
HXDLIN(  19)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  19)			point->_inPool = false;
HXDLIN(  19)			 ::flixel::math::FlxBasePoint this1 = point;
