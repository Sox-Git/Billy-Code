...
HXDLIN(  43)				 ::flixel::math::FlxBasePoint this1 = this->justPressedPosition;
...
HXDLIN(  43)				Float y = this1->y;
HXDLIN(  43)				p->set_x(this1->x);
HXDLIN(  43)				p->set_y(y);
HXDLIN(  43)				 ::flixel::math::FlxBasePoint _hx_tmp2 = ::flixel::FlxG_obj::mouse->getScreenPosition(null(),null());
