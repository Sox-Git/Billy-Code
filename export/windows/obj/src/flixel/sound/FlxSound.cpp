...
HXLINE( 311)				Float lowerBound;
HXDLIN( 311)				if ((d < -1)) {
HXLINE( 311)					lowerBound = ( (Float)(-1) );
            				}
            				else {
HXLINE( 311)					lowerBound = d;
            				}
HXDLIN( 311)				Float _hx_tmp;
HXDLIN( 311)				if ((lowerBound > 1)) {
HXLINE( 311)					_hx_tmp = ( (Float)(1) );
            				}
            				else {
HXLINE( 311)					_hx_tmp = lowerBound;
            				}
...
HXLINE( 331)			_hx_tmp = ::hx::IsGreaterEq( this->_time,this->endTime );
            		}
            		else {
