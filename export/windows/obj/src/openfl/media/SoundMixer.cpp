...
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_172_stopAll,"openfl.media.SoundMixer","stopAll",0x7ebb1d93,"openfl.media.SoundMixer.stopAll","openfl/media/SoundMixer.hx",172,0x17e3a43a)
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_183___registerSoundChannel,"openfl.media.SoundMixer","__registerSoundChannel",0x60ebf103,"openfl.media.SoundMixer.__registerSoundChannel","openfl/media/SoundMixer.hx",183,0x17e3a43a)
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_188___unregisterSoundChannel,"openfl.media.SoundMixer","__unregisterSoundChannel",0xb1bc24dc,"openfl.media.SoundMixer.__unregisterSoundChannel","openfl/media/SoundMixer.hx",188,0x17e3a43a)
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_194_get_soundTransform,"openfl.media.SoundMixer","get_soundTransform",0xc6a43892,"openfl.media.SoundMixer.get_soundTransform","openfl/media/SoundMixer.hx",194,0x17e3a43a)
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_199___unregisterSoundChannelByBuffer,"openfl.media.SoundMixer","__unregisterSoundChannelByBuffer",0x73c61f33,"openfl.media.SoundMixer.__unregisterSoundChannelByBuffer","openfl/media/SoundMixer.hx",199,0x17e3a43a)
HX_LOCAL_STACK_FRAME(_hx_pos_1587d256662a54fa_214_set_soundTransform,"openfl.media.SoundMixer","set_soundTransform",0xa3536b06,"openfl.media.SoundMixer.set_soundTransform","openfl/media/SoundMixer.hx",214,0x17e3a43a)
...
void SoundMixer_obj::stopAll(){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_172_stopAll)
HXLINE( 173)		int i = ::openfl::media::SoundMixer_obj::_hx___soundChannels->length;
HXLINE( 174)		while((i > 0)){
HXLINE( 176)			::openfl::media::SoundMixer_obj::_hx___soundChannels->__get(i).StaticCast<  ::openfl::media::SoundChannel >()->stop();
HXLINE( 177)			i = (i - 1);
            		}
            	}
...
void SoundMixer_obj::_hx___registerSoundChannel( ::openfl::media::SoundChannel soundChannel){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_183___registerSoundChannel)
HXDLIN( 183)		::openfl::media::SoundMixer_obj::_hx___soundChannels->push(soundChannel);
            	}
...
void SoundMixer_obj::_hx___unregisterSoundChannel( ::openfl::media::SoundChannel soundChannel){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_188___unregisterSoundChannel)
HXDLIN( 188)		::openfl::media::SoundMixer_obj::_hx___soundChannels->remove(soundChannel);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(SoundMixer_obj,_hx___unregisterSoundChannel,(void))
 ...
 ::openfl::media::SoundTransform SoundMixer_obj::get_soundTransform(){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_194_get_soundTransform)
HXDLIN( 194)		return ::openfl::media::SoundMixer_obj::_hx___soundTransform;
            	}
...
void SoundMixer_obj::_hx___unregisterSoundChannelByBuffer( ::lime::media::AudioBuffer buffer){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_199___unregisterSoundChannelByBuffer)
HXLINE( 200)		int i = ::openfl::media::SoundMixer_obj::_hx___soundChannels->length;
HXLINE( 201)		while((i > 0)){
HXLINE( 203)			 ::openfl::media::SoundChannel channel = ::openfl::media::SoundMixer_obj::_hx___soundChannels->__get(i).StaticCast<  ::openfl::media::SoundChannel >();
HXLINE( 204)			if (::hx::IsInstanceEq( channel->_hx___audioSource->buffer,buffer )) {
HXLINE( 206)				channel->stop();
            			}
HXLINE( 208)			i = (i - 1);
            		}
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(SoundMixer_obj,_hx___unregisterSoundChannelByBuffer,(void))
 ...
 ::openfl::media::SoundTransform SoundMixer_obj::set_soundTransform( ::openfl::media::SoundTransform value){
            	HX_STACKFRAME(&_hx_pos_1587d256662a54fa_214_set_soundTransform)
HXLINE( 215)		::openfl::media::SoundMixer_obj::_hx___soundTransform = value->clone();
HXLINE( 217)		{
HXLINE( 217)			int _g = 0;
HXDLIN( 217)			::Array< ::Dynamic> _g1 = ::openfl::media::SoundMixer_obj::_hx___soundChannels;
HXDLIN( 217)			while((_g < _g1->length)){
HXLINE( 217)				 ::openfl::media::SoundChannel channel = _g1->__get(_g).StaticCast<  ::openfl::media::SoundChannel >();
HXDLIN( 217)				_g = (_g + 1);
HXLINE( 219)				channel->_hx___updateTransform();
            			}
            		}
