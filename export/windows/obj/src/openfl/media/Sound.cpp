...
HXLINE( 535)			int a = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(bytes);
HXDLIN( 535)			bool aNeg = (a < 0);
HXDLIN( 535)			bool bNeg = (bytesLength < 0);
HXDLIN( 535)			if ((aNeg != bNeg)) {
HXLINE( 535)				_hx_tmp1 = aNeg;
            			}
            			else {
HXLINE( 535)				_hx_tmp1 = (a > bytesLength);
            			}
            		}
            		else {
...
HXLINE( 537)			 ::openfl::utils::ByteArrayData this1 =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,bytesLength);
HXDLIN( 537)			 ::openfl::utils::ByteArrayData copy = this1;
...
HXLINE( 634)			int a = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(bytes);
HXDLIN( 634)			bool aNeg = (a < 0);
HXDLIN( 634)			bool bNeg = (bytesLength < 0);
HXDLIN( 634)			if ((aNeg != bNeg)) {
HXLINE( 634)				_hx_tmp = aNeg;
            			}
            			else {
HXLINE( 634)				_hx_tmp = (a > bytesLength);
            			}
            		}
            		else {
...
HXLINE( 636)			 ::openfl::utils::ByteArrayData this1 =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,bytesLength);
HXDLIN( 636)			 ::openfl::utils::ByteArrayData copy = this1;
...
HXDLIN( 645)				 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXLINE( 645)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 645)					::cpp::VirtualArray array = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 645)					_this->byteOffset = 0;
HXDLIN( 645)					_this->length = array->get_length();
HXDLIN( 645)					_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN( 645)					 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXDLIN( 645)						int elementSize = _this->bytesPerElement;
HXDLIN( 645)						if ((view->type == _this->type)) {
HXLINE( 645)							int srcLength = srcData->length;
HXDLIN( 645)							int cloneLength = (srcLength - srcByteOffset);
HXDLIN( 645)							 ::haxe::io::Bytes this1 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 645)							_this->buffer = this1;
HXDLIN( 645)							_this->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 645)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("unimplemented",09,2f,74,b4)));
            						}
HXDLIN( 645)						_this->byteLength = (_this->bytesPerElement * srcLength);
HXDLIN( 645)						_this->byteOffset = 0;
HXDLIN( 645)						_this->length = srcLength;
HXDLIN( 645)						this1 = _this;
            					}
            					else {
...
HXLINE( 645)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            							}
HXDLIN( 645)							if ((::hx::Mod(in_byteOffset,_this->bytesPerElement) != 0)) {
HXLINE( 645)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            							}
...
HXDLIN( 645)								if ((::hx::Mod(bufferByteLength,_this->bytesPerElement) != 0)) {
HXLINE( 645)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
...
HXLINE( 645)								newByteLength = (( (int)(len) ) * _this->bytesPerElement);
HXDLIN( 645)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 645)								if ((newRange > bufferByteLength)) {
HXLINE( 645)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
            							}
HXDLIN( 645)							_this->buffer = buffer;
HXDLIN( 645)							_this->byteOffset = in_byteOffset;
HXDLIN( 645)							_this->byteLength = newByteLength;
HXDLIN( 645)							_this->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this->bytesPerElement) )));
HXDLIN( 645)							this1 = _this;
            						}
            						else {
HXLINE( 645)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85)));
            						}
            					}
            				}
            			}
...
HXLINE( 771)					 cpp::Int64Struct x = this->_hx___buffer->_hx___srcVorbisFile->pcmTotal(null());
HXDLIN( 771)					int _hx_tmp = _hx_int64_high(x);
HXDLIN( 771)					if ((_hx_tmp != (_hx_int64_low(x) >> 31))) {
HXLINE( 771)						HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Overflow",62,9f,ed,1a)));
            					}
HXDLIN( 771)					int samples = _hx_int64_low(x);
HXLINE( 772)					return ::Std_obj::_hx_int(((( (Float)(samples) ) / ( (Float)(this->_hx___buffer->sampleRate) )) * ( (Float)(1000) )));
            				}
            				else {
HXLINE( 776)					return 0;
            				}
