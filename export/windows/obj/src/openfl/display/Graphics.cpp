...
HX_LOCAL_STACK_FRAME(_hx_pos_043516e11ce5c7d5_1874___update,"openfl.display.Graphics","__update",0x711b5982,"openfl.display.Graphics.__update","openfl/display/Graphics.hx",1874,0x8d299ce7)
HX_LOCAL_STACK_FRAME(_hx_pos_043516e11ce5c7d5_2027_set___dirty,"openfl.display.Graphics","set___dirty",0x3f74a55c,"openfl.display.Graphics.set___dirty","openfl/display/Graphics.hx",2027,0x8d299ce7)
...
HXLINE(1766)		 ::openfl::display::GraphicsStroke stroke;
HXLINE(1768)		{
HXLINE(1768)			int _g = 0;
HXDLIN(1768)			::Array< ::Dynamic> _g1 = this->_hx___commands->types;
HXDLIN(1768)			while((_g < _g1->length)){
HXLINE(1768)				 ::openfl::display::_internal::DrawCommandType type = _g1->__get(_g).StaticCast<  ::openfl::display::_internal::DrawCommandType >();
HXDLIN(1768)				_g = (_g + 1);
HXLINE(1770)				switch((int)(type->_hx_getIndex())){
            					case (int)4: case (int)5: case (int)6: case (int)7: case (int)9: case (int)10: case (int)17: case (int)18: {
HXLINE(1773)						if (::hx::IsNull( path )) {
HXLINE(1775)							path =  ::openfl::display::GraphicsPath_obj::__alloc( HX_CTX ,null(),null(),null());
            						}
            					}
            					break;
            					default:{
HXLINE(1779)						if (::hx::IsNotNull( path )) {
HXLINE(1781)							graphicsData->push(path);
HXLINE(1782)							path = null();
            						}
            					}
            				}
HXLINE(1786)				switch((int)(type->_hx_getIndex())){
            					case (int)0: {
HXLINE(1848)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1848)								data1->oPos = (data1->oPos + 2);
HXDLIN(1848)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1848)								data2->bPos = (data2->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1848)								data1->iPos = (data1->iPos + 1);
HXDLIN(1848)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1848)								data2->fPos = (data2->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1848)								data1->oPos = (data1->oPos + 4);
HXDLIN(1848)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1848)								data2->iiPos = (data2->iiPos + 2);
HXDLIN(1848)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1848)								data3->ffPos = (data3->ffPos + 1);
HXDLIN(1848)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1848)								data4->fPos = (data4->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1848)								data1->oPos = (data1->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1848)								data1->fPos = (data1->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1848)								data1->fPos = (data1->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1848)								data1->fPos = (data1->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1848)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)8: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1848)								data1->oPos = (data1->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1848)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)10: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1848)								data1->fPos = (data1->fPos + 5);
HXDLIN(1848)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1848)								data2->oPos = (data2->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXDLIN(1848)								data1->oPos = (data1->oPos + 4);
HXDLIN(1848)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1848)								data2->iPos = (data2->iPos + 1);
HXDLIN(1848)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1848)								data3->fPos = (data3->fPos + 2);
HXDLIN(1848)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1848)								data4->bPos = (data4->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1848)								data1->fPos = (data1->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1848)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXLINE(1848)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::BEGIN_BITMAP_FILL_dyn();
HXDLIN(1848)						 ::openfl::display::_internal::DrawCommandReader this1 = data;
HXDLIN(1848)						 ::openfl::display::_internal::DrawCommandReader c = this1;
HXLINE(1849)						graphicsData->push( ::openfl::display::GraphicsBitmapFill_obj::__alloc( HX_CTX ,( ( ::openfl::display::BitmapData)(c->buffer->o->__get(c->oPos)) ),( ( ::openfl::geom::Matrix)(c->buffer->o->__get((c->oPos + 1))) ),c->buffer->b->__get(c->bPos),c->buffer->b->__get((c->bPos + 1))));
            					}
            					break;
            					case (int)1: {
HXLINE(1852)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1852)								data1->oPos = (data1->oPos + 2);
HXDLIN(1852)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1852)								data2->bPos = (data2->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1852)								data1->iPos = (data1->iPos + 1);
HXDLIN(1852)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1852)								data2->fPos = (data2->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1852)								data1->oPos = (data1->oPos + 4);
HXDLIN(1852)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1852)								data2->iiPos = (data2->iiPos + 2);
HXDLIN(1852)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1852)								data3->ffPos = (data3->ffPos + 1);
HXDLIN(1852)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1852)								data4->fPos = (data4->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1852)								data1->oPos = (data1->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1852)								data1->fPos = (data1->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1852)								data1->fPos = (data1->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1852)								data1->fPos = (data1->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1852)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)8: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1852)								data1->oPos = (data1->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1852)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)10: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1852)								data1->fPos = (data1->fPos + 5);
HXDLIN(1852)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1852)								data2->oPos = (data2->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXDLIN(1852)								data1->oPos = (data1->oPos + 4);
HXDLIN(1852)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1852)								data2->iPos = (data2->iPos + 1);
HXDLIN(1852)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1852)								data3->fPos = (data3->fPos + 2);
HXDLIN(1852)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1852)								data4->bPos = (data4->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1852)								data1->fPos = (data1->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1852)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXLINE(1852)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::BEGIN_FILL_dyn();
HXDLIN(1852)						 ::openfl::display::_internal::DrawCommandReader this1 = data;
HXDLIN(1852)						 ::openfl::display::_internal::DrawCommandReader c = this1;
HXLINE(1853)						graphicsData->push( ::openfl::display::GraphicsSolidFill_obj::__alloc( HX_CTX ,c->buffer->i->__get(c->iPos),1));
            					}
            					break;
            					case (int)2: {
HXLINE(1856)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1856)								data1->oPos = (data1->oPos + 2);
HXDLIN(1856)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1856)								data2->bPos = (data2->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1856)								data1->iPos = (data1->iPos + 1);
HXDLIN(1856)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1856)								data2->fPos = (data2->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1856)								data1->oPos = (data1->oPos + 4);
HXDLIN(1856)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1856)								data2->iiPos = (data2->iiPos + 2);
HXDLIN(1856)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1856)								data3->ffPos = (data3->ffPos + 1);
HXDLIN(1856)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1856)								data4->fPos = (data4->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1856)								data1->oPos = (data1->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1856)								data1->fPos = (data1->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1856)								data1->fPos = (data1->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1856)								data1->fPos = (data1->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1856)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)8: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1856)								data1->oPos = (data1->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1856)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)10: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1856)								data1->fPos = (data1->fPos + 5);
HXDLIN(1856)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1856)								data2->oPos = (data2->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXDLIN(1856)								data1->oPos = (data1->oPos + 4);
HXDLIN(1856)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1856)								data2->iPos = (data2->iPos + 1);
HXDLIN(1856)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1856)								data3->fPos = (data3->fPos + 2);
HXDLIN(1856)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1856)								data4->bPos = (data4->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1856)								data1->fPos = (data1->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1856)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXLINE(1856)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::BEGIN_GRADIENT_FILL_dyn();
HXDLIN(1856)						 ::openfl::display::_internal::DrawCommandReader this1 = data;
HXDLIN(1856)						 ::openfl::display::_internal::DrawCommandReader c = this1;
HXLINE(1857)						graphicsData->push( ::openfl::display::GraphicsGradientFill_obj::__alloc( HX_CTX ,c->buffer->o->__get(c->oPos),c->buffer->ii->__get(c->iiPos).StaticCast< ::Array< int > >(),c->buffer->ff->__get(c->ffPos).StaticCast< ::Array< Float > >(),c->buffer->ii->__get((c->iiPos + 1)).StaticCast< ::Array< int > >(),( ( ::openfl::geom::Matrix)(c->buffer->o->__get((c->oPos + 1))) ),c->buffer->o->__get((c->oPos + 2)),c->buffer->o->__get((c->oPos + 3)),c->buffer->f->__get(c->fPos)));
            					}
            					break;
            					case (int)3: {
            					}
...
HXLINE(1789)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::CUBIC_CURVE_TO_dyn();
...
HXLINE(1790)						path->cubicCurveTo(c->buffer->f->__get(c->fPos),c->buffer->f->__get((c->fPos + 1)),c->buffer->f->__get((c->fPos + 2)),c->buffer->f->__get((c->fPos + 3)),c->buffer->f->__get((c->fPos + 4)),c->buffer->f->__get((c->fPos + 5)));
            					}
            					break;
            					case (int)5: {
HXLINE(1793)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1793)								data1->oPos = (data1->oPos + 2);
HXDLIN(1793)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1793)								data2->bPos = (data2->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1793)								data1->iPos = (data1->iPos + 1);
HXDLIN(1793)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1793)								data2->fPos = (data2->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1793)								data1->oPos = (data1->oPos + 4);
HXDLIN(1793)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1793)								data2->iiPos = (data2->iiPos + 2);
HXDLIN(1793)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1793)								data3->ffPos = (data3->ffPos + 1);
HXDLIN(1793)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1793)								data4->fPos = (data4->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1793)								data1->oPos = (data1->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1793)								data1->fPos = (data1->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1793)								data1->fPos = (data1->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1793)								data1->fPos = (data1->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1793)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)8: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1793)								data1->oPos = (data1->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1793)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)10: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1793)								data1->fPos = (data1->fPos + 5);
HXDLIN(1793)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1793)								data2->oPos = (data2->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXDLIN(1793)								data1->oPos = (data1->oPos + 4);
HXDLIN(1793)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1793)								data2->iPos = (data2->iPos + 1);
HXDLIN(1793)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1793)								data3->fPos = (data3->fPos + 2);
HXDLIN(1793)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1793)								data4->bPos = (data4->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1793)								data1->fPos = (data1->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1793)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXLINE(1793)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::CURVE_TO_dyn();
HXDLIN(1793)						 ::openfl::display::_internal::DrawCommandReader this1 = data;
HXDLIN(1793)						 ::openfl::display::_internal::DrawCommandReader c = this1;
HXLINE(1794)						path->curveTo(c->buffer->f->__get(c->fPos),c->buffer->f->__get((c->fPos + 1)),c->buffer->f->__get((c->fPos + 2)),c->buffer->f->__get((c->fPos + 3)));
            					}
            					break;
            					case (int)6: {
...
HXLINE(1805)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::DRAW_CIRCLE_dyn();
HXDLIN(1805)						 ::openfl::display::_internal::DrawCommandReader this1 = data;
HXDLIN(1805)						 ::openfl::display::_internal::DrawCommandReader c = this1;
HXLINE(1806)						path->_hx___drawCircle(c->buffer->f->__get(c->fPos),c->buffer->f->__get((c->fPos + 1)),c->buffer->f->__get((c->fPos + 2)));
            					}
            					break;
            					case (int)7: {
...
HXLINE(1809)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::DRAW_ELLIPSE_dyn();
...
HXLINE(1810)						path->_hx___drawEllipse(c->buffer->f->__get(c->fPos),c->buffer->f->__get((c->fPos + 1)),c->buffer->f->__get((c->fPos + 2)),c->buffer->f->__get((c->fPos + 3)));
            					}
            					break;
            					case (int)9: {
...
HXLINE(1813)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::DRAW_RECT_dyn();
...
HXLINE(1814)						path->_hx___drawRect(c->buffer->f->__get(c->fPos),c->buffer->f->__get((c->fPos + 1)),c->buffer->f->__get((c->fPos + 2)),c->buffer->f->__get((c->fPos + 3)));
            					}
            					break;
            					case (int)10: {
...
HXLINE(1817)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::DRAW_ROUND_RECT_dyn();
...
HXLINE(1818)						Float _hx_tmp;
HXDLIN(1818)						if (::hx::IsNotNull( c->buffer->o->__get(c->oPos) )) {
HXLINE(1818)							_hx_tmp = ( (Float)(c->buffer->o->__get(c->oPos)) );
            						}
            						else {
HXLINE(1818)							_hx_tmp = c->buffer->f->__get((c->fPos + 4));
            						}
HXDLIN(1818)						path->_hx___drawRoundRect(c->buffer->f->__get(c->fPos),c->buffer->f->__get((c->fPos + 1)),c->buffer->f->__get((c->fPos + 2)),c->buffer->f->__get((c->fPos + 3)),c->buffer->f->__get((c->fPos + 4)),_hx_tmp);
            					}
            					break;
            					case (int)13: {
HXLINE(1844)						{
...
HXLINE(1844)							data->prev = ::openfl::display::_internal::DrawCommandType_obj::END_FILL_dyn();
HXDLIN(1844)							 ::openfl::display::_internal::DrawCommandReader this1 = data;
            						}
HXLINE(1845)						graphicsData->push( ::openfl::display::GraphicsEndFill_obj::__alloc( HX_CTX ));
            					}
            					break;
            					case (int)14: {
HXLINE(1831)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1831)								data1->oPos = (data1->oPos + 2);
HXDLIN(1831)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1831)								data2->bPos = (data2->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1831)								data1->iPos = (data1->iPos + 1);
HXDLIN(1831)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1831)								data2->fPos = (data2->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1831)								data1->oPos = (data1->oPos + 4);
HXDLIN(1831)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1831)								data2->iiPos = (data2->iiPos + 2);
HXDLIN(1831)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1831)								data3->ffPos = (data3->ffPos + 1);
HXDLIN(1831)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1831)								data4->fPos = (data4->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1831)								data1->oPos = (data1->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1831)								data1->fPos = (data1->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1831)								data1->fPos = (data1->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1831)								data1->fPos = (data1->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1831)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)8: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1831)								data1->oPos = (data1->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1831)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)10: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1831)								data1->fPos = (data1->fPos + 5);
HXDLIN(1831)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1831)								data2->oPos = (data2->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXDLIN(1831)								data1->oPos = (data1->oPos + 4);
HXDLIN(1831)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1831)								data2->iPos = (data2->iPos + 1);
HXDLIN(1831)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1831)								data3->fPos = (data3->fPos + 2);
HXDLIN(1831)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1831)								data4->bPos = (data4->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1831)								data1->fPos = (data1->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1831)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXLINE(1831)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::LINE_BITMAP_STYLE_dyn();
HXDLIN(1831)						 ::openfl::display::_internal::DrawCommandReader this1 = data;
HXDLIN(1831)						 ::openfl::display::_internal::DrawCommandReader c = this1;
HXLINE(1832)						path = null();
            					}
            					break;
            					case (int)15: {
HXLINE(1823)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1823)								data1->oPos = (data1->oPos + 2);
HXDLIN(1823)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1823)								data2->bPos = (data2->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1823)								data1->iPos = (data1->iPos + 1);
HXDLIN(1823)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1823)								data2->fPos = (data2->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1823)								data1->oPos = (data1->oPos + 4);
HXDLIN(1823)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1823)								data2->iiPos = (data2->iiPos + 2);
HXDLIN(1823)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1823)								data3->ffPos = (data3->ffPos + 1);
HXDLIN(1823)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1823)								data4->fPos = (data4->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1823)								data1->oPos = (data1->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1823)								data1->fPos = (data1->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1823)								data1->fPos = (data1->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1823)								data1->fPos = (data1->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1823)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)8: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1823)								data1->oPos = (data1->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1823)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)10: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1823)								data1->fPos = (data1->fPos + 5);
HXDLIN(1823)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1823)								data2->oPos = (data2->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXDLIN(1823)								data1->oPos = (data1->oPos + 4);
HXDLIN(1823)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1823)								data2->iPos = (data2->iPos + 1);
HXDLIN(1823)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1823)								data3->fPos = (data3->fPos + 2);
HXDLIN(1823)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1823)								data4->bPos = (data4->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1823)								data1->fPos = (data1->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1823)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXLINE(1823)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::LINE_GRADIENT_STYLE_dyn();
HXDLIN(1823)						 ::openfl::display::_internal::DrawCommandReader this1 = data;
HXDLIN(1823)						 ::openfl::display::_internal::DrawCommandReader c = this1;
            					}
            					break;
            					case (int)16: {
HXLINE(1838)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1838)								data1->oPos = (data1->oPos + 2);
HXDLIN(1838)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1838)								data2->bPos = (data2->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1838)								data1->iPos = (data1->iPos + 1);
HXDLIN(1838)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1838)								data2->fPos = (data2->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1838)								data1->oPos = (data1->oPos + 4);
HXDLIN(1838)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1838)								data2->iiPos = (data2->iiPos + 2);
HXDLIN(1838)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1838)								data3->ffPos = (data3->ffPos + 1);
HXDLIN(1838)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1838)								data4->fPos = (data4->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1838)								data1->oPos = (data1->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1838)								data1->fPos = (data1->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1838)								data1->fPos = (data1->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1838)								data1->fPos = (data1->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1838)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)8: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1838)								data1->oPos = (data1->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1838)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)10: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1838)								data1->fPos = (data1->fPos + 5);
HXDLIN(1838)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1838)								data2->oPos = (data2->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXDLIN(1838)								data1->oPos = (data1->oPos + 4);
HXDLIN(1838)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1838)								data2->iPos = (data2->iPos + 1);
HXDLIN(1838)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1838)								data3->fPos = (data3->fPos + 2);
HXDLIN(1838)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1838)								data4->bPos = (data4->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1838)								data1->fPos = (data1->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1838)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXLINE(1838)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::LINE_STYLE_dyn();
HXDLIN(1838)						 ::openfl::display::_internal::DrawCommandReader this1 = data;
HXDLIN(1838)						 ::openfl::display::_internal::DrawCommandReader c = this1;
HXLINE(1839)						stroke =  ::openfl::display::GraphicsStroke_obj::__alloc( HX_CTX ,c->buffer->o->__get(c->oPos),c->buffer->b->__get(c->bPos),c->buffer->o->__get((c->oPos + 1)),c->buffer->o->__get((c->oPos + 2)),c->buffer->o->__get((c->oPos + 3)),c->buffer->f->__get((c->fPos + 1)),null());
HXLINE(1840)						stroke->fill =  ::openfl::display::GraphicsSolidFill_obj::__alloc( HX_CTX ,c->buffer->i->__get(c->iPos),c->buffer->f->__get(c->fPos));
HXLINE(1841)						graphicsData->push(stroke);
            					}
            					break;
            					case (int)17: {
HXLINE(1797)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1797)								data1->oPos = (data1->oPos + 2);
HXDLIN(1797)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1797)								data2->bPos = (data2->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1797)								data1->iPos = (data1->iPos + 1);
HXDLIN(1797)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1797)								data2->fPos = (data2->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1797)								data1->oPos = (data1->oPos + 4);
HXDLIN(1797)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1797)								data2->iiPos = (data2->iiPos + 2);
HXDLIN(1797)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1797)								data3->ffPos = (data3->ffPos + 1);
HXDLIN(1797)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1797)								data4->fPos = (data4->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1797)								data1->oPos = (data1->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1797)								data1->fPos = (data1->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1797)								data1->fPos = (data1->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1797)								data1->fPos = (data1->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1797)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)8: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1797)								data1->oPos = (data1->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1797)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)10: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1797)								data1->fPos = (data1->fPos + 5);
HXDLIN(1797)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1797)								data2->oPos = (data2->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXDLIN(1797)								data1->oPos = (data1->oPos + 4);
HXDLIN(1797)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1797)								data2->iPos = (data2->iPos + 1);
HXDLIN(1797)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1797)								data3->fPos = (data3->fPos + 2);
HXDLIN(1797)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1797)								data4->bPos = (data4->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1797)								data1->fPos = (data1->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1797)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXLINE(1797)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::LINE_TO_dyn();
HXDLIN(1797)						 ::openfl::display::_internal::DrawCommandReader this1 = data;
HXDLIN(1797)						 ::openfl::display::_internal::DrawCommandReader c = this1;
HXLINE(1798)						path->lineTo(c->buffer->f->__get(c->fPos),c->buffer->f->__get((c->fPos + 1)));
            					}
            					break;
            					case (int)18: {
HXLINE(1801)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1801)								data1->oPos = (data1->oPos + 2);
HXDLIN(1801)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1801)								data2->bPos = (data2->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1801)								data1->iPos = (data1->iPos + 1);
HXDLIN(1801)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1801)								data2->fPos = (data2->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1801)								data1->oPos = (data1->oPos + 4);
HXDLIN(1801)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1801)								data2->iiPos = (data2->iiPos + 2);
HXDLIN(1801)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1801)								data3->ffPos = (data3->ffPos + 1);
HXDLIN(1801)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1801)								data4->fPos = (data4->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1801)								data1->oPos = (data1->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1801)								data1->fPos = (data1->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1801)								data1->fPos = (data1->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1801)								data1->fPos = (data1->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1801)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)8: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1801)								data1->oPos = (data1->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1801)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)10: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1801)								data1->fPos = (data1->fPos + 5);
HXDLIN(1801)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1801)								data2->oPos = (data2->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXDLIN(1801)								data1->oPos = (data1->oPos + 4);
HXDLIN(1801)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1801)								data2->iPos = (data2->iPos + 1);
HXDLIN(1801)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1801)								data3->fPos = (data3->fPos + 2);
HXDLIN(1801)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1801)								data4->bPos = (data4->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1801)								data1->fPos = (data1->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1801)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXLINE(1801)						data->prev = ::openfl::display::_internal::DrawCommandType_obj::MOVE_TO_dyn();
HXDLIN(1801)						 ::openfl::display::_internal::DrawCommandReader this1 = data;
HXDLIN(1801)						 ::openfl::display::_internal::DrawCommandReader c = this1;
HXLINE(1802)						path->moveTo(c->buffer->f->__get(c->fPos),c->buffer->f->__get((c->fPos + 1)));
            					}
            					break;
            					default:{
HXLINE(1863)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1863)								data1->oPos = (data1->oPos + 2);
HXDLIN(1863)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1863)								data2->bPos = (data2->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1863)								data1->iPos = (data1->iPos + 1);
HXDLIN(1863)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1863)								data2->fPos = (data2->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1863)								data1->oPos = (data1->oPos + 4);
HXDLIN(1863)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1863)								data2->iiPos = (data2->iiPos + 2);
HXDLIN(1863)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1863)								data3->ffPos = (data3->ffPos + 1);
HXDLIN(1863)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1863)								data4->fPos = (data4->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1863)								data1->oPos = (data1->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1863)								data1->fPos = (data1->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1863)								data1->fPos = (data1->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1863)								data1->fPos = (data1->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1863)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)8: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1863)								data1->oPos = (data1->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1863)								data1->fPos = (data1->fPos + 4);
            							...
            							case (int)10: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1863)								data1->fPos = (data1->fPos + 5);
HXDLIN(1863)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1863)								data2->oPos = (data2->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXDLIN(1863)								data1->oPos = (data1->oPos + 4);
HXDLIN(1863)								 ::openfl::display::_internal::DrawCommandReader data2 = data;
HXDLIN(1863)								data2->iPos = (data2->iPos + 1);
HXDLIN(1863)								 ::openfl::display::_internal::DrawCommandReader data3 = data;
HXDLIN(1863)								data3->fPos = (data3->fPos + 2);
HXDLIN(1863)								 ::openfl::display::_internal::DrawCommandReader data4 = data;
HXDLIN(1863)								data4->bPos = (data4->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
HXDLIN(1863)								data1->fPos = (data1->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1863)								 ::openfl::display::_internal::DrawCommandReader data1 = data;
...
HXLINE(1863)						data->prev = type;
            					}
            				}
            			}
            		}
HXLINE(1867)		if (::hx::IsNotNull( path )) {
HXLINE(1869)			graphicsData->push(path);
            		}
            	}
...
void Graphics_obj::_hx___update( ::openfl::geom::Matrix displayMatrix,Float pixelRatio){
            	HX_STACKFRAME(&_hx_pos_043516e11ce5c7d5_1874___update)
HXLINE(1875)		bool _hx_tmp;
HXDLIN(1875)		bool _hx_tmp1;
HXDLIN(1875)		if (::hx::IsNotNull( this->_hx___bounds )) {
HXLINE(1875)			_hx_tmp1 = (this->_hx___bounds->width <= 0);
            		}
            		else {
HXLINE(1875)			_hx_tmp1 = true;
            		}
HXDLIN(1875)		if (!(_hx_tmp1)) {
HXLINE(1875)			_hx_tmp = (this->_hx___bounds->height <= 0);
            		}
            		else {
HXLINE(1875)			_hx_tmp = true;
            		}
HXDLIN(1875)		if (_hx_tmp) {
HXLINE(1875)			return;
            		}
HXLINE(1877)		 ::openfl::geom::Matrix parentTransform = this->_hx___owner->_hx___renderTransform;
HXLINE(1878)		if (::hx::IsNull( parentTransform )) {
HXLINE(1878)			return;
            		}
HXLINE(1880)		Float scaleX = pixelRatio;
HXDLIN(1880)		Float scaleY = pixelRatio;
HXLINE(1882)		if (::hx::IsNull( this->_hx___owner->_hx___worldScale9Grid )) {
HXLINE(1884)			if ((parentTransform->b == 0)) {
HXLINE(1886)				scaleX = ::Math_obj::abs(parentTransform->a);
            			}
            			else {
HXLINE(1890)				scaleX = ::Math_obj::sqrt(((parentTransform->a * parentTransform->a) + (parentTransform->b * parentTransform->b)));
            			}
HXLINE(1893)			if ((parentTransform->c == 0)) {
HXLINE(1895)				scaleY = ::Math_obj::abs(parentTransform->d);
            			}
            			else {
HXLINE(1899)				scaleY = ::Math_obj::sqrt(((parentTransform->c * parentTransform->c) + (parentTransform->d * parentTransform->d)));
            			}
HXLINE(1902)			if (::hx::IsNotNull( displayMatrix )) {
HXLINE(1904)				if ((displayMatrix->b == 0)) {
HXLINE(1906)					scaleX = (scaleX * displayMatrix->a);
            				}
            				else {
HXLINE(1910)					scaleX = (scaleX * ::Math_obj::sqrt(((displayMatrix->a * displayMatrix->a) + (displayMatrix->b * displayMatrix->b))));
            				}
HXLINE(1913)				if ((displayMatrix->c == 0)) {
HXLINE(1915)					scaleY = (scaleY * displayMatrix->d);
            				}
            				else {
HXLINE(1919)					scaleY = (scaleY * ::Math_obj::sqrt(((displayMatrix->c * displayMatrix->c) + (displayMatrix->d * displayMatrix->d))));
            				}
            			}
            		}
HXLINE(1929)		Float width = (this->_hx___bounds->width * scaleX);
HXLINE(1930)		Float height = (this->_hx___bounds->height * scaleY);
HXLINE(1932)		bool _hx_tmp2;
HXDLIN(1932)		if (!((width < 1))) {
HXLINE(1932)			_hx_tmp2 = (height < 1);
            		}
            		else {
HXLINE(1932)			_hx_tmp2 = true;
            		}
HXDLIN(1932)		if (_hx_tmp2) {
HXLINE(1934)			bool _hx_tmp;
HXDLIN(1934)			if ((this->_hx___width < 1)) {
HXLINE(1934)				_hx_tmp = (this->_hx___height >= 1);
            			}
            			else {
HXLINE(1934)				_hx_tmp = true;
            			}
HXDLIN(1934)			if (_hx_tmp) {
HXLINE(1934)				this->set___dirty(true);
            			}
HXLINE(1935)			this->_hx___width = 0;
HXLINE(1936)			this->_hx___height = 0;
HXLINE(1937)			return;
            		}
HXLINE(1940)		bool _hx_tmp3;
HXDLIN(1940)		if (::hx::IsNotNull( ::openfl::display::Graphics_obj::maxTextureWidth )) {
HXLINE(1940)			_hx_tmp3 = ::hx::IsGreater( width,::openfl::display::Graphics_obj::maxTextureWidth );
            		}
            		else {
HXLINE(1940)			_hx_tmp3 = false;
            		}
HXDLIN(1940)		if (_hx_tmp3) {
HXLINE(1942)			width = ( (Float)(::openfl::display::Graphics_obj::maxTextureWidth) );
HXLINE(1943)			scaleX = (( (Float)(::openfl::display::Graphics_obj::maxTextureWidth) ) / this->_hx___bounds->width);
            		}
HXLINE(1946)		bool _hx_tmp4;
HXDLIN(1946)		if (::hx::IsNotNull( ::openfl::display::Graphics_obj::maxTextureWidth )) {
HXLINE(1946)			_hx_tmp4 = ::hx::IsGreater( height,::openfl::display::Graphics_obj::maxTextureHeight );
            		}
            		else {
HXLINE(1946)			_hx_tmp4 = false;
            		}
HXDLIN(1946)		if (_hx_tmp4) {
HXLINE(1948)			height = ( (Float)(::openfl::display::Graphics_obj::maxTextureHeight) );
HXLINE(1949)			scaleY = (( (Float)(::openfl::display::Graphics_obj::maxTextureHeight) ) / this->_hx___bounds->height);
            		}
HXLINE(1952)		Float inverseA;
HXDLIN(1952)		Float inverseD;
HXLINE(1954)		if (::hx::IsNotNull( this->_hx___owner->_hx___worldScale9Grid )) {
HXLINE(1956)			this->_hx___renderTransform->a = pixelRatio;
HXLINE(1957)			this->_hx___renderTransform->d = pixelRatio;
HXLINE(1958)			inverseA = (( (Float)(1) ) / pixelRatio);
HXLINE(1959)			inverseD = (( (Float)(1) ) / pixelRatio);
            		}
            		else {
HXLINE(1963)			this->_hx___renderTransform->a = (width / this->_hx___bounds->width);
HXLINE(1964)			this->_hx___renderTransform->d = (height / this->_hx___bounds->height);
HXLINE(1965)			inverseA = (( (Float)(1) ) / this->_hx___renderTransform->a);
HXLINE(1966)			inverseD = (( (Float)(1) ) / this->_hx___renderTransform->d);
            		}
HXLINE(1970)		this->_hx___worldTransform->a = (inverseA * parentTransform->a);
HXLINE(1971)		this->_hx___worldTransform->b = (inverseA * parentTransform->b);
HXLINE(1972)		this->_hx___worldTransform->c = (inverseD * parentTransform->c);
HXLINE(1973)		this->_hx___worldTransform->d = (inverseD * parentTransform->d);
HXLINE(1975)		Float x = this->_hx___bounds->x;
HXLINE(1976)		Float y = this->_hx___bounds->y;
HXLINE(1977)		Float tx = (((x * parentTransform->a) + (y * parentTransform->c)) + parentTransform->tx);
HXLINE(1978)		Float ty = (((x * parentTransform->b) + (y * parentTransform->d)) + parentTransform->ty);
HXLINE(1985)		if ((pixelRatio > ((Float)1.0))) {
HXLINE(1991)			Float nativePixelSize = (( (Float)(1) ) / pixelRatio);
HXLINE(1992)			this->_hx___worldTransform->tx = (::Math_obj::fround((tx / nativePixelSize)) * nativePixelSize);
HXLINE(1993)			this->_hx___worldTransform->ty = (::Math_obj::fround((ty / nativePixelSize)) * nativePixelSize);
            		}
            		else {
HXLINE(1997)			this->_hx___worldTransform->tx = ::Math_obj::fround(tx);
HXLINE(1998)			this->_hx___worldTransform->ty = ::Math_obj::fround(ty);
            		}
HXLINE(2002)		 ::openfl::geom::Matrix _this = this->_hx___worldTransform;
HXDLIN(2002)		Float norm = ((_this->a * _this->d) - (_this->b * _this->c));
HXDLIN(2002)		Float _hx_tmp5;
HXDLIN(2002)		if ((norm == 0)) {
HXLINE(2002)			_hx_tmp5 = -(_this->tx);
            		}
            		else {
HXLINE(2002)			_hx_tmp5 = ((((Float)1.0) / norm) * ((_this->c * (_this->ty - ty)) + (_this->d * (tx - _this->tx))));
            		}
HXDLIN(2002)		this->_hx___renderTransform->tx = _hx_tmp5;
HXLINE(2003)		 ::openfl::geom::Matrix _this1 = this->_hx___worldTransform;
HXDLIN(2003)		Float norm1 = ((_this1->a * _this1->d) - (_this1->b * _this1->c));
HXDLIN(2003)		Float _hx_tmp6;
HXDLIN(2003)		if ((norm1 == 0)) {
HXLINE(2003)			_hx_tmp6 = -(_this1->ty);
            		}
            		else {
HXLINE(2003)			_hx_tmp6 = ((((Float)1.0) / norm1) * ((_this1->a * (ty - _this1->ty)) + (_this1->b * (_this1->tx - tx))));
            		}
HXDLIN(2003)		this->_hx___renderTransform->ty = _hx_tmp6;
HXLINE(2010)		int newWidth = ::Math_obj::ceil((width + ((Float)1.0)));
HXLINE(2011)		int newHeight = ::Math_obj::ceil((height + ((Float)1.0)));
HXLINE(2014)		bool _hx_tmp7;
HXDLIN(2014)		if ((newWidth == this->_hx___width)) {
HXLINE(2014)			_hx_tmp7 = (newHeight != this->_hx___height);
            		}
            		else {
HXLINE(2014)			_hx_tmp7 = true;
            		}
HXDLIN(2014)		if (_hx_tmp7) {
HXLINE(2017)			this->set___dirty(true);
            		}
HXLINE(2021)		this->_hx___width = newWidth;
HXLINE(2022)		this->_hx___height = newHeight;
            	}
...
bool Graphics_obj::set___dirty(bool value){
            	HX_STACKFRAME(&_hx_pos_043516e11ce5c7d5_2027_set___dirty)
HXLINE(2028)		bool _hx_tmp;
HXDLIN(2028)		if (value) {
HXLINE(2028)			_hx_tmp = ::hx::IsNotNull( this->_hx___owner );
            		}
            		else {
HXLINE(2028)			_hx_tmp = false;
            		}
HXDLIN(2028)		if (_hx_tmp) {
HXLINE(2030)			 ::openfl::display::DisplayObject _this = this->_hx___owner;
HXDLIN(2030)			if (!(_this->_hx___renderDirty)) {
HXLINE(2030)				_this->_hx___renderDirty = true;
HXDLIN(2030)				_this->_hx___setParentRenderDirty();
            			}
            		}
HXLINE(2033)		if (value) {
HXLINE(2035)			this->_hx___softwareDirty = true;
HXLINE(2036)			this->_hx___hardwareDirty = true;
            		}
HXLINE(2039)		return (this->_hx___dirty = value);
            	}
