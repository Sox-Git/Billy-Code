...
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1022___setBlendMode,"openfl.display.OpenGLRenderer","__setBlendMode",0xc7ebe4e4,"openfl.display.OpenGLRenderer.__setBlendMode","openfl/display/OpenGLRenderer.hx",1022,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1059___setRenderTarget,"openfl.display.OpenGLRenderer","__setRenderTarget",0xe23db0b7,"openfl.display.OpenGLRenderer.__setRenderTarget","openfl/display/OpenGLRenderer.hx",1059,0x89bd8a40)
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1070___setShaderBuffer,"openfl.display.OpenGLRenderer","__setShaderBuffer",0x2c781375,"openfl.display.OpenGLRenderer.__setShaderBuffer","openfl/display/OpenGLRenderer.hx",1070,0x89bd8a40)
...
HX_LOCAL_STACK_FRAME(_hx_pos_2f59d7e567bca573_1091___updateShaderBuffer,"openfl.display.OpenGLRenderer","__updateShaderBuffer",0x07dc8fc0,"openfl.display.OpenGLRenderer.__updateShaderBuffer","openfl/display/OpenGLRenderer.hx",1091,0x89bd8a40)
...
HXLINE( 959)			 ::openfl::geom::Matrix _this = this->_hx___worldTransform;
HXDLIN( 959)			_hx_tmp1 = ::Math_obj::round((((( (Float)(0) ) * _this->b) + (( (Float)(0) ) * _this->d)) + _this->ty));
            		}
            		else {
...
HXLINE( 960)			 ::openfl::geom::Matrix _this = this->_hx___worldTransform;
HXDLIN( 960)			_hx_tmp2 = ::Math_obj::round(((((( (Float)(w) ) * _this->a) + (( (Float)(0) ) * _this->c)) + _this->tx) - ( (Float)(this->_hx___offsetX) )));
            		}
            		else {
...
HXLINE( 961)			 ::openfl::geom::Matrix _this = this->_hx___worldTransform;
HXDLIN( 961)			_hx_tmp3 = ::Math_obj::round(((((( (Float)(0) ) * _this->b) + (( (Float)(h) ) * _this->d)) + _this->ty) - ( (Float)(this->_hx___offsetY) )));
            		}
            		else {
...
HXLINE( 994)			int x = ::Math_obj::floor(clipRect->x);
HXLINE( 995)			int y = ::Math_obj::floor(clipRect->y);
HXLINE( 996)			int width;
HXDLIN( 996)			if ((clipRect->width > 0)) {
HXLINE( 996)				width = (::Math_obj::ceil(clipRect->get_right()) - x);
            			}
            			else {
HXLINE( 996)				width = 0;
            			}
HXLINE( 997)			int height;
HXDLIN( 997)			if ((clipRect->height > 0)) {
HXLINE( 997)				height = (::Math_obj::ceil(clipRect->get_bottom()) - y);
            			}
            			else {
HXLINE( 997)				height = 0;
            			}
HXLINE( 999)			if (this->_hx___context3D->_hx___backBufferWantsBestResolution) {
HXLINE(1001)				x = ::Math_obj::floor((clipRect->x / this->_hx___pixelRatio));
HXLINE(1002)				y = ::Math_obj::floor((clipRect->y / this->_hx___pixelRatio));
HXLINE(1003)				if ((clipRect->width > 0)) {
HXLINE(1003)					Float width1 = clipRect->get_right();
HXDLIN(1003)					width = (::Math_obj::ceil((width1 / this->_hx___pixelRatio)) - x);
            				}
            				else {
HXLINE(1003)					width = 0;
            				}
HXLINE(1004)				if ((clipRect->height > 0)) {
HXLINE(1004)					Float height1 = clipRect->get_bottom();
HXDLIN(1004)					height = (::Math_obj::ceil((height1 / this->_hx___pixelRatio)) - y);
            				}
            				else {
HXLINE(1004)					height = 0;
            				}
            			}
HXLINE(1008)			if ((width < 0)) {
HXLINE(1008)				width = 0;
            			}
HXLINE(1009)			if ((height < 0)) {
HXLINE(1009)				height = 0;
            			}
HXLINE(1012)			::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle->setTo(( (Float)(x) ),( (Float)(y) ),( (Float)(width) ),( (Float)(height) ));
HXLINE(1013)			this->_hx___context3D->setScissorRectangle(::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle);
            		}
            		else {
HXLINE(1017)			this->_hx___context3D->setScissorRectangle(null());
            		}
            	}
...
void OpenGLRenderer_obj::_hx___setBlendMode( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1022___setBlendMode)
HXLINE(1023)		if (::hx::IsNotNull( this->_hx___overrideBlendMode )) {
HXLINE(1023)			value = this->_hx___overrideBlendMode;
            		}
HXLINE(1024)		if (::hx::IsEq( this->_hx___blendMode,value )) {
HXLINE(1024)			return;
            		}
HXLINE(1026)		this->_hx___blendMode = value;
HXLINE(1028)		 ::Dynamic _hx_switch_0 = value;
            		if (  (_hx_switch_0==0) ){
HXLINE(1031)			this->_hx___context3D->setBlendFactors(2,2);
HXDLIN(1031)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(1045)			this->_hx___context3D->setBlendFactors(2,2);
HXLINE(1046)			this->_hx___context3D->_hx___setGLBlendEquation(32775);
HXLINE(1044)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==8) ){
HXLINE(1049)			this->_hx___context3D->setBlendFactors(2,2);
HXLINE(1050)			this->_hx___context3D->_hx___setGLBlendEquation(32776);
HXLINE(1048)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==9) ){
HXLINE(1034)			this->_hx___context3D->setBlendFactors(1,5);
HXDLIN(1034)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==12) ){
HXLINE(1037)			this->_hx___context3D->setBlendFactors(2,6);
HXDLIN(1037)			goto _hx_goto_35;
            		}
            		if (  (_hx_switch_0==14) ){
HXLINE(1040)			this->_hx___context3D->setBlendFactors(2,2);
...
HXLINE(1039)			goto _hx_goto_35;
            		...
            		/* default */{
HXLINE(1054)			this->_hx___context3D->setBlendFactors(2,5);
            		}
            		_hx_goto_35:;
            	}
...
void OpenGLRenderer_obj::_hx___setRenderTarget( ::openfl::display::BitmapData renderTarget){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1059___setRenderTarget)
HXLINE(1060)		this->_hx___defaultRenderTarget = renderTarget;
HXLINE(1061)		this->_hx___flipped = ::hx::IsNull( renderTarget );
HXLINE(1063)		if (::hx::IsNotNull( renderTarget )) {
HXLINE(1065)			this->_hx___resize(renderTarget->width,renderTarget->height);
            		}
            	}
...
void OpenGLRenderer_obj::_hx___setShaderBuffer( ::openfl::display::_internal::ShaderBuffer shaderBuffer){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1070___setShaderBuffer)
HXLINE(1071)		this->setShader(shaderBuffer->shader);
HXLINE(1072)		this->_hx___currentShaderBuffer = shaderBuffer;
            	}
...
HXLINE(1077)		if ((this->_hx___stencilReference > 0)) {
HXLINE(1079)			this->_hx___context3D->setStencilActions(null(),null(),null(),null(),null());
HXLINE(1080)			this->_hx___context3D->setStencilReferenceValue(0,0,0);
            		}
HXLINE(1083)		if ((this->_hx___numClipRects > 0)) {
HXLINE(1085)			this->_hx___scissorRect(null());
            		}
            	}
...
void OpenGLRenderer_obj::_hx___updateShaderBuffer(int bufferOffset){
            	HX_STACKFRAME(&_hx_pos_2f59d7e567bca573_1091___updateShaderBuffer)
HXDLIN(1091)		bool _hx_tmp;
HXDLIN(1091)		if (::hx::IsNotNull( this->_hx___currentShader )) {
HXDLIN(1091)			_hx_tmp = ::hx::IsNotNull( this->_hx___currentShaderBuffer );
            		}
            		else {
HXDLIN(1091)			_hx_tmp = false;
            		}
HXDLIN(1091)		if (_hx_tmp) {
HXLINE(1093)			this->_hx___currentShader->_hx___updateFromBuffer(this->_hx___currentShaderBuffer,bufferOffset);
            		}
            	}
