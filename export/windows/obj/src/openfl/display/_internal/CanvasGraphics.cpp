...
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_465_hitTest,"openfl.display._internal.CanvasGraphics","hitTest",0x934efa96,"openfl.display._internal.CanvasGraphics.hitTest","openfl/display/_internal/CanvasGraphics.hx",465,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_470_isCCW,"openfl.display._internal.CanvasGraphics","isCCW",0x9437381e,"openfl.display._internal.CanvasGraphics.isCCW","openfl/display/_internal/CanvasGraphics.hx",470,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_474_normalizeUVT,"openfl.display._internal.CanvasGraphics","normalizeUVT",0xa0796975,"openfl.display._internal.CanvasGraphics.normalizeUVT","openfl/display/_internal/CanvasGraphics.hx",474,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_515_playCommands,"openfl.display._internal.CanvasGraphics","playCommands",0xa3390eeb,"openfl.display._internal.CanvasGraphics.playCommands","openfl/display/_internal/CanvasGraphics.hx",515,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_1149_render,"openfl.display._internal.CanvasGraphics","render",0xc2394625,"openfl.display._internal.CanvasGraphics.render","openfl/display/_internal/CanvasGraphics.hx",1149,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_1475_renderMask,"openfl.display._internal.CanvasGraphics","renderMask",0x605729b1,"openfl.display._internal.CanvasGraphics.renderMask","openfl/display/_internal/CanvasGraphics.hx",1475,0x5a71bf7c)
HX_LOCAL_STACK_FRAME(_hx_pos_fd1c4d1c82edf2db_1579_setSmoothing,"openfl.display._internal.CanvasGraphics","setSmoothing",0x137bf581,"openfl.display._internal.CanvasGraphics.setSmoothing","openfl/display/_internal/CanvasGraphics.hx",1579,0x5a71bf7c)
...
bool CanvasGraphics_obj::hitTest( ::openfl::display::Graphics graphics,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_465_hitTest)
...
bool CanvasGraphics_obj::isCCW(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_470_isCCW)
HXDLIN( 470)		return ((((x2 - x1) * (y3 - y1)) - ((y2 - y1) * (x3 - x1))) < 0);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC6(CanvasGraphics_obj,isCCW,return )
 ...
 ::Dynamic CanvasGraphics_obj::normalizeUVT( ::openfl::_Vector::FloatVector uvt,::hx::Null< bool >  __o_skipT){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_474_normalizeUVT)
HXLINE( 475)		Float max = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 476)		Float tmp = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 477)		int len = uvt->get_length();
HXLINE( 479)		{
HXLINE( 479)			int _g = 1;
HXDLIN( 479)			int _g1 = (len + 1);
HXDLIN( 479)			while((_g < _g1)){
HXLINE( 479)				_g = (_g + 1);
HXDLIN( 479)				int t = (_g - 1);
HXLINE( 481)				bool _hx_tmp;
HXDLIN( 481)				if (skipT) {
HXLINE( 481)					_hx_tmp = (::hx::Mod(t,3) == 0);
            				}
            				else {
...
HXLINE( 486)				tmp = uvt->get((t - 1));
HXLINE( 488)				if ((max < tmp)) {
HXLINE( 490)					max = tmp;
            				}
            			}
            		}
HXLINE( 494)		if (!(skipT)) {
HXLINE( 496)			return  ::Dynamic(::hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("max",a4,0a,53,00),max)
            				->setFixed(1,HX_("uvt",f3,2e,59,00),uvt));
            		}
HXLINE( 499)		int length = null();
HXDLIN( 499)		bool fixed = null();
HXDLIN( 499)		::Array< Float > array = null();
HXDLIN( 499)		 ::openfl::_Vector::FloatVector result =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,array,true);
HXLINE( 501)		{
HXLINE( 501)			int _g2 = 1;
HXDLIN( 501)			int _g3 = (len + 1);
HXDLIN( 501)			while((_g2 < _g3)){
HXLINE( 501)				_g2 = (_g2 + 1);
HXDLIN( 501)				int t = (_g2 - 1);
HXLINE( 503)				bool _hx_tmp;
HXDLIN( 503)				if (skipT) {
HXLINE( 503)					_hx_tmp = (::hx::Mod(t,3) == 0);
            				}
            				else {
...
HXLINE( 508)				result->push(uvt->get((t - 1)));
            			}
            		}
...
void CanvasGraphics_obj::playCommands( ::openfl::display::_internal::DrawCommandBuffer commands,::hx::Null< bool >  __o_stroke){
            	...
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_515_playCommands)
            	}
...
void CanvasGraphics_obj::render( ::openfl::display::Graphics graphics, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_1149_render)
            	}
...
void CanvasGraphics_obj::renderMask( ::openfl::display::Graphics graphics, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_1475_renderMask)
            	}
...
void CanvasGraphics_obj::setSmoothing(bool smooth){
            	HX_STACKFRAME(&_hx_pos_fd1c4d1c82edf2db_1579_setSmoothing)
            	}
