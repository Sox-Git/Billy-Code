...
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_189_browse,"lime.ui.FileDialog","browse",0xc1264193,"lime.ui.FileDialog.browse","lime/ui/FileDialog.hx",189,0x296febf9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_249_open,"lime.ui.FileDialog","open",0x8e9b2393,"lime.ui.FileDialog.open","lime/ui/FileDialog.hx",249,0x296febf9)
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_268_open,"lime.ui.FileDialog","open",0x8e9b2393,"lime.ui.FileDialog.open","lime/ui/FileDialog.hx",268,0x296febf9)
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_244_open,"lime.ui.FileDialog","open",0x8e9b2393,"lime.ui.FileDialog.open","lime/ui/FileDialog.hx",244,0x296febf9)
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_319_save,"lime.ui.FileDialog","save",0x9134ab06,"lime.ui.FileDialog.save","lime/ui/FileDialog.hx",319,0x296febf9)
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_338_save,"lime.ui.FileDialog","save",0x9134ab06,"lime.ui.FileDialog.save","lime/ui/FileDialog.hx",338,0x296febf9)
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_308_save,"lime.ui.FileDialog","save",0x9134ab06,"lime.ui.FileDialog.save","lime/ui/FileDialog.hx",308,0x296febf9)
namespace lime{
namespace ui{
...
HXLINE( 118)					path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_file(title,filter,defaultPath);
HXLINE( 122)					worker->sendComplete(( ( ::Dynamic)(path) ));
            				}
            				break;
            				case (int)1: {
HXLINE( 129)					 ::hx::Object * paths = ::hx::DynamicPtr(null());
HXLINE( 142)					paths = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_files(title,filter,defaultPath);
HXLINE( 146)					worker->sendComplete(( ( ::Dynamic)(paths) ));
            				}
            				break;
            				case (int)2: {
HXLINE( 170)					 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 179)					path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title,filter,defaultPath);
HXLINE( 183)					worker->sendComplete(( ( ::Dynamic)(path) ));
            				}
            				break;
            				case (int)3: {
HXLINE( 153)					 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 159)					path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_directory(title,filter,defaultPath);
HXLINE( 163)					worker->sendComplete(( ( ::Dynamic)(path) ));
            		...
            		void _hx_run( ::Dynamic result){
            			HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_189_browse)
HXLINE( 189)			switch((int)(type1->__get(0).StaticCast<  ::lime::ui::FileDialogType >()->_hx_getIndex())){
            				case (int)0: case (int)2: case (int)3: {
HXLINE( 192)					::String path = ( (::String)(result) );
HXLINE( 194)					if (::hx::IsNotNull( path )) {
HXLINE( 197)						bool _hx_tmp;
HXDLIN( 197)						bool _hx_tmp1;
HXDLIN( 197)						if (::hx::IsPointerEq( type1->__get(0).StaticCast<  ::lime::ui::FileDialogType >(),::lime::ui::FileDialogType_obj::SAVE_dyn() )) {
HXLINE( 197)							_hx_tmp1 = ::hx::IsNotNull( filter );
            						}
            						else {
HXLINE( 197)							_hx_tmp1 = false;
            						}
HXDLIN( 197)						if (_hx_tmp1) {
HXLINE( 197)							_hx_tmp = (path.indexOf(HX_(".",2e,00,00,00),null()) == -1);
            						}
            						else {
HXLINE( 197)							_hx_tmp = false;
            						}
HXDLIN( 197)						if (_hx_tmp) {
HXLINE( 199)							path = (path + (HX_(".",2e,00,00,00) + filter));
            						}
HXLINE( 202)						_gthis->onSelect->dispatch(path);
            					}
            					else {
HXLINE( 206)						_gthis->onCancel->dispatch();
            					}
            				}
            				break;
            				case (int)1: {
HXLINE( 210)					::Array< ::String > paths = ( (::Array< ::String >)(result) );
HXLINE( 212)					bool _hx_tmp;
HXDLIN( 212)					if (::hx::IsNotNull( paths )) {
HXLINE( 212)						_hx_tmp = (paths->length > 0);
            					}
            					else {
HXLINE( 212)						_hx_tmp = false;
            					}
HXDLIN( 212)					if (_hx_tmp) {
HXLINE( 214)						_gthis->onSelectMultiple->dispatch(paths);
            					}
            					else {
...
HXLINE( 187)		worker->onComplete->add( ::Dynamic(new _hx_Closure_1(_gthis,type1,filter)),null(),null());
HXLINE( 223)		worker->run(null());
...
bool FileDialog_obj::open(::String filter,::String defaultPath,::String title){
            		...
            		void _hx_run( ::Dynamic _){
            			HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_249_open)
HXLINE( 254)			 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 260)			path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_file(title,filter,defaultPath);
HXLINE( 264)			worker->sendComplete(( ( ::Dynamic)(path) ));
            		}
            		HX_END_LOCAL_FUNC1((void))

            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_1, ::lime::ui::FileDialog,_gthis) HXARGC(1)
            		void _hx_run(::String path){
            			HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_268_open)
HXLINE( 269)			if (::hx::IsNotNull( path )) {
HXLINE( 271)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 273)					 ::haxe::io::Bytes data = ::sys::io::File_obj::getBytes(path);
HXLINE( 274)					_gthis->onOpen->dispatch(data);
HXLINE( 275)					return;
            				} catch( ::Dynamic _hx_e) {
...
HXLINE( 280)			_gthis->onCancel->dispatch();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_244_open)
HXDLIN( 244)		 ::lime::ui::FileDialog _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 246)		 ::lime::_hx_system::BackgroundWorker worker =  ::lime::_hx_system::BackgroundWorker_obj::__alloc( HX_CTX );
HXLINE( 248)		worker->doWork->add( ::Dynamic(new _hx_Closure_0(title,worker,filter,defaultPath)),null(),null());
HXLINE( 267)		worker->onComplete->add( ::Dynamic(new _hx_Closure_1(_gthis)),null(),null());
HXLINE( 283)		worker->run(null());
...
bool FileDialog_obj::save( ::haxe::io::Bytes data,::String filter,::String defaultPath,::String title,::String __o_type){
            		HX_BEGIN_LOCAL_FUNC_S4(::hx::LocalFunc,_hx_Closure_0,::String,title, ::lime::_hx_system::BackgroundWorker,worker,::String,filter,::String,defaultPath) HXARGC(1)
            		void _hx_run( ::Dynamic _){
            			HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_319_save)
HXLINE( 324)			 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 330)			path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title,filter,defaultPath);
HXLINE( 334)			worker->sendComplete(( ( ::Dynamic)(path) ));
            		}
            		HX_END_LOCAL_FUNC1((void))

            		HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_1, ::lime::ui::FileDialog,_gthis, ::haxe::io::Bytes,data) HXARGC(1)
            		void _hx_run(::String path){
            			HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_338_save)
HXLINE( 339)			if (::hx::IsNotNull( path )) {
HXLINE( 341)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 343)					::sys::io::File_obj::saveBytes(path,data);
HXLINE( 344)					_gthis->onSave->dispatch(path);
HXLINE( 345)					return;
            				} catch( ::Dynamic _hx_e) {
            					if (_hx_e.IsClass<  ::Dynamic >() ){
            						HX_STACK_BEGIN_CATCH
...
HXLINE( 350)			_gthis->onCancel->dispatch();
            		}
            		HX_END_LOCAL_FUNC1((void))

            		::String type = __o_type;
            		if (::hx::IsNull(__o_type)) type = HX_("application/octet-stream",5d,f8,82,30);
            	HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_308_save)
HXDLIN( 308)		 ::lime::ui::FileDialog _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 309)		if (::hx::IsNull( data )) {
HXLINE( 311)			this->onCancel->dispatch();
HXLINE( 312)			return false;
            		}
HXLINE( 316)		 ::lime::_hx_system::BackgroundWorker worker =  ::lime::_hx_system::BackgroundWorker_obj::__alloc( HX_CTX );
HXLINE( 318)		worker->doWork->add( ::Dynamic(new _hx_Closure_0(title,worker,filter,defaultPath)),null(),null());
HXLINE( 337)		worker->onComplete->add( ::Dynamic(new _hx_Closure_1(_gthis,data)),null(),null());
HXLINE( 353)		worker->run(null());
