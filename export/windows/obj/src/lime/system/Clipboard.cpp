...
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_69_get_text,"lime.system.Clipboard","get_text",0xe647e374,"lime.system.Clipboard.get_text","lime/system/Clipboard.hx",69,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_100_set_text,"lime.system.Clipboard","set_text",0x94a53ce8,"lime.system.Clipboard.set_text","lime/system/Clipboard.hx",100,0x9490b5ee)
...
HXLINE(  59)		::lime::_hx_system::Clipboard_obj::_hx___updated = true;
HXLINE(  61)		if ((::lime::_hx_system::Clipboard_obj::_text != cacheText)) {
HXLINE(  63)			::lime::_hx_system::Clipboard_obj::onUpdate->dispatch();
            		}
            	}
...
::String Clipboard_obj::get_text(){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_69_get_text)
HXLINE(  87)		if (!(::lime::_hx_system::Clipboard_obj::_hx___updated)) {
HXLINE(  92)			::lime::_hx_system::Clipboard_obj::_hx___update();
            		}
HXLINE(  96)		return ::lime::_hx_system::Clipboard_obj::_text;
            	}
...
::String Clipboard_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_100_set_text)
HXLINE( 101)		::String cacheText = ::lime::_hx_system::Clipboard_obj::_text;
HXLINE( 102)		::lime::_hx_system::Clipboard_obj::_text = value;
HXLINE( 105)		::lime::_internal::backend::native::NativeCFFI_obj::lime_clipboard_set_text(value);
HXLINE( 116)		if ((::lime::_hx_system::Clipboard_obj::_text != cacheText)) {
HXLINE( 118)			::lime::_hx_system::Clipboard_obj::onUpdate->dispatch();
            		}
