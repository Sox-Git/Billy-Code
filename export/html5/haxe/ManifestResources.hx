...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_bb1_titletheme1_ogg extends null { }
...
@:keep @:file("assets/music/BB1/TitleTheme1.ogg") @:noCompletion #if display private #end class __ASSET__assets_music_bb1_titletheme1_ogg extends haxe.io.Bytes {}
